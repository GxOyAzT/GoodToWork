...
namespace GoodToWork.TasksOrganizer.Infrastructure.Persistance.Migrations
{
    ...
    [Migration("20220222020551_AddUpdatorForStatus")]
    partial class AddUpdatorForStatus
    {
            ...
            modelBuilder.Entity("GoodToWork.TasksOrganizer.Domain.Entities.StatusEntity", b =>
                {
                    ...
                    b.HasOne("GoodToWork.TasksOrganizer.Domain.Entities.UserEntity", "Updator")
                        .WithMany("ChangedStatuses")
